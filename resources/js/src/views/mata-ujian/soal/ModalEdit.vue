<template>
  <b-modal v-model="addModalShow" title="Edit Soal Ujian" size="lg" @ok="handleOk" @hidden="hideModal">
...
export default {
  ...
  created() {
    eventBus.$on('open-modal-edit-soal', this.handleEvent);
  },
  methods: {
    handleEvent(data){
      this.form.soal_ujian_id = data.id
      this.form.semester_id = this.user.semester.semester_id
      this.form.sekolah_id = data.jadwal_ujian.rombongan_belajar.sekolah_id
      this.form.tingkat = data.jadwal_ujian.rombongan_belajar.tingkat_pendidikan_id
      this.form.rombongan_belajar_id = data.jadwal_ujian.rombongan_belajar_id
      this.form.jadwal_id = data.jadwal_ujian.jadwal_id
      this.form.jadwal_ujian_id = data.jadwal_ujian_id
      this.form.jumlah_soal = data.jumlah_soal
      this.form.jumlah_pg = data.jumlah_pg
